                            ...
                            return (
                                <Card key={reminder.id} className="list-group-item" draggable>
                                    ...
                                    <div>
                                        ...
                                        <Moment minDate={new Date(2020, 9, 17)} calendar={calendarStrings}>{reminder.minDate}</Moment>
                                        <br></br>
                                        <Moment type="text"  maxDate={new Date(2020, 9, 19)} add={{ days: 2 }}>{reminder.maxDate}</Moment>
                                    </div>
                                </Card>
                            )
                        })
        ...
        return (
            <div className={useStyles.root}>
                ...
                {/* <ScheduleComponent
                    ...
                    minDate={new Date(2020, 9, 17)}
                    maxDate={new Date(2020, 9, 19)}
...
export default connect(mapStateToProps, { addReminder, deleteReminder, clearReminders })(Crm3);
